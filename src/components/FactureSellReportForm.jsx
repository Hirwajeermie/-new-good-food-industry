...
function FactureSellReportForm() {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { name: "c_tin", label: "Customer Tin", type: "text" },
                { name: "c_name", label: "Customer Name", type: "text", step: "0.01" },
...
export default FactureSellReportForm;
